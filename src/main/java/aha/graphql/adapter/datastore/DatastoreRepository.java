package aha.graphql.adapter.datastore;

import aha.graphql.domain.model.Image;
import aha.graphql.domain.model.Screenshot;
import aha.graphql.adapter.datastore.jpa.ScreenshotJpa;
import aha.graphql.adapter.datastore.mapper.EntityMapper;
import aha.graphql.adapter.datastore.model.ScreenshotEntity;
import aha.graphql.domain.ScreenshotRepository;
